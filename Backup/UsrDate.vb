...
#End Region
    Private Sub UsrDate_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtYear.KeyPress, txtMonth.KeyPress, txtDay.KeyPress
        '数字
        If e.KeyChar.IsDigit(e.KeyChar.ToString.Chars(0)) = True Then

            'backspace,enter
        ElseIf e.KeyChar.IsControl(e.KeyChar.ToString.Chars(0)) = True Then

            'アルファベット
        ElseIf e.KeyChar.IsLetter(e.KeyChar.ToString.Chars(0)) = True Then
            e.Handled = True

            '区切り文字
        ElseIf e.KeyChar.IsPunctuation(e.KeyChar.ToString.Chars(0)) = True Then
            e.Handled = True

            'サロゲート文字
        ElseIf e.KeyChar.IsSurrogate(e.KeyChar.ToString.Chars(0)) = True Then
            e.Handled = True

            'シンボル
        ElseIf e.KeyChar.IsSymbol(e.KeyChar.ToString.Chars(0)) = True Then
            e.Handled = True

            'スペース
        ElseIf e.KeyChar.IsWhiteSpace(e.KeyChar.ToString.Chars(0)) = True Then
            e.Handled = True
