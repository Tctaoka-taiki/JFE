...
#End Region
    Public Sub gSubAutoColSize()
        Me.AutoSizeCols(Me.pAutoColSizeF, Me.pAutoColSizeT, Me.mIntAutoColSpace)
    End Sub
    ...
    Public Sub gSubSetTotal()
        ...
        For Each intCol In Me.mTotalColllection
            ...
            For i = Me.pRowCount(EnmRowCount.Enm固定行数) To Me.Rows.Count - 1
                ...
                End If
            Next
            Me(Me.gCIntTotalRow, intCol) = Format(dlbTotal, Me.Cols(intCol).Format)
        Next
        Me.Rows(Me.gCIntTotalRow).StyleNew.Font = New System.Drawing.Font("ＭＳ ゴシック", 11.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(128, Byte))
    End Sub
