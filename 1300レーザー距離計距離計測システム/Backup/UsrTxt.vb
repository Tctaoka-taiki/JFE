...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    Public Sub New()
        ...
        Me.mCharType = Me.EnmCharType.All
    ...
    Private Sub UsrTxt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        If Char.IsDigit(e.KeyChar) Then
            Select Case Me.mCharType
                Case Me.EnmCharType.All, Me.EnmCharType.Numonly, EnmCharType.NumLetter, EnmCharType.WildNumonly, EnmCharType.WildNumLetter
        ...
        ElseIf Char.IsLetter(e.KeyChar) Then
            Select Case Me.mCharType
                Case Me.EnmCharType.All, Me.EnmCharType.Letter, EnmCharType.NumLetter, EnmCharType.WildLetter, EnmCharType.WildNumLetter
            ...
            If Me.pCharType <> EnmCharType.All Then
                For i = 0 To strBuff.Length - 1
                    ...
                    Case strBuff.Chars(i).IsDigit(strBuff.Chars(i))
                            ...
                            End Select
                            ''文字
                        Case strBuff.Chars(i).IsLetter(strBuff.Chars(i))
                            Select Case Me.pCharType
